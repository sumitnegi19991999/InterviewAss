  ...
  const careerPaths = [
    {
      ...
      description:
        "Germany leads in automotive, manufacturing, and renewable energy",
    ...
    },
    {
      ...
      description:
        "Strong financial sector with opportunities in major European markets",
    ...
    },
    {
      ...
      description:
        "Growing tech scene with startups and multinational corporations",
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-primary-foreground/90 max-w-3xl mx-auto mb-8">
            Discover the vast career landscape that awaits you in Germany. From
            engineering excellence to cutting-edge technology, find your path to
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Germany offers exceptional career opportunities across various
              industries. Here are the most promising fields for international
              graduates.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Germany offers some of the highest salaries in Europe,
                      with excellent work-life balance and comprehensive
                      benefits.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Home to global leaders in automotive, engineering, and
                      manufacturing industries with cutting-edge technology.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      German work culture emphasizes efficiency and balance,
                      with generous vacation time and flexible working
                      arrangements.
                    </p>
                  </div>
                </div>
