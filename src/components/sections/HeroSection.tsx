        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold text-white leading-tight">
                ...
                <span className="relative inline-block">
                  <span className="bg-accent text-accent-foreground px-3 py-2 rounded-lg inline-block animate-pulse">Germany</span>
                </span>
              </h1>
              
              <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-xl animate-fade-in" style={{animationDelay: '0.3s'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-fade-in" style={{animationDelay: '0.6s'}}>
              <Button variant="accent" size="lg" className="text-base font-semibold hover-scale">
                Explore Programs
                <ArrowRight size={20} />
              </Button>
              <Button variant="outline" size="lg" className="bg-white/10 border-white/20 text-white hover:bg-white/20 hover-scale">
                <Play size={20} />
            ...
            {/* Quick Stats */}
            <div className="grid grid-cols-3 gap-6 pt-8 animate-fade-in" style={{animationDelay: '0.9s'}}>
