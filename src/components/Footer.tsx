      ...
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              ...
              to Indian students for their German education journey.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><Link to="/career" className="text-muted-foreground hover:text-primary transition-colors text-sm">Career Opportunities</Link></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><span className="text-muted-foreground text-sm">University Selection</span></li>
              <li><span className="text-muted-foreground text-sm">Visa Assistance</span></li>
              <li><span className="text-muted-foreground text-sm">Scholarship Guidance</span></li>
              <li><span className="text-muted-foreground text-sm">Career Counseling</span></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground text-sm">info@connectgermany.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-muted-foreground text-sm">
            © 2024 ConnectGermany. All rights reserved. | Privacy Policy | Terms of Service
          </p>
        </div>
      </div>
    </footer>
